...
$msg['es']=array(
    ...
    'Error: problem whith the file '=>'Error con el archivo ',
    'Error : remote file is unavailable'=>'Error: el archivo no está en el servidor',
...
function id_user(){$id=array();$id['HTTP_USER_AGENT']=$_SERVER['HTTP_USER_AGENT'];$id['session_id']=session_id();$id=serialize($id);return $id;}
